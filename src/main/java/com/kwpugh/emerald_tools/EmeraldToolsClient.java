...
public class EmeraldToolsClient implements ClientModInitializer 
{
  ...
  {
    FabricModelPredicateProviderRegistry.register(ItemInit.EMERALD_BOW, new Identifier("pull"), (stack, world, entity) -> 
    {
      if (entity == null) 
      {
        return 0.0F;
    ...
    FabricModelPredicateProviderRegistry.register(ItemInit.RUBY_BOW, new Identifier("pull"), (stack, world, entity) -> 
    {
      if (entity == null) 
      {
        return 0.0F;
    ...
    FabricModelPredicateProviderRegistry.register(ItemInit.OBSIDIAN_BOW, new Identifier("pull"), (stack, world, entity) -> 
    {
      if (entity == null) 
      {
        return 0.0F;
    ...
    FabricModelPredicateProviderRegistry.register(ItemInit.STEEL_BOW, new Identifier("pull"), (stack, world, entity) -> 
    {
      if (entity == null) 
      {
        return 0.0F;
