...
public class ItemInit
{
	...
	{		
		 ...
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "emerald_excavator"), EMERALD_EXCAVATOR);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "emerald_hammer"), EMERALD_HAMMER);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "emerald_paxel"), EMERALD_PAXEL);
		 ...
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "ruby_excavator"), RUBY_EXCAVATOR);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "ruby_hammer"), RUBY_HAMMER);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "ruby_paxel"), RUBY_PAXEL);
		 ...
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "steel_excavator"), STEEL_EXCAVATOR);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "steel_hammer"), STEEL_HAMMER);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "steel_paxel"), STEEL_PAXEL);
		 ...
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "obsidian_excavator"), OBSIDIAN_EXCAVATOR);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "obsidian_hammer"), OBSIDIAN_HAMMER);
		 Registry.register(Registry.ITEM, new Identifier("emerald_tools", "obsidian_paxel"), OBSIDIAN_PAXEL);
